const homeUI = (() => {
  ...
  const translations = {
    uk: {
      ...
      "slides.s1.title": "SGM «VESNA»",
      "slides.s1.titleHtml": "<span class=\"ref-title-accent\">Мала керована ракета</span><br>SGM «VESNA»",
      "slides.s1.p1": "SGM «Vesna» — це керована ракета на базі серійної платформи Hydra 70, призначена для масового застосування проти малогабаритних повітряних цілей.",
      ...
      "slides.s3.p1": "SGM «Vesna» реалізує модернізацію стандартної ракети Hydra 70 за рахунок встановлення модуля керування та впровадження комбінованої системи наведення.",
      "slides.s3.list1": "маса ~14 кг",
      "slides.s3.list2": "довжина ~1,8 м",
      ...
      "sections.architecture.list1": "керовані ракети SGM «Vesna»",
    ...
    en: {
      ...
      "slides.s1.title": "SGM “VESNA”",
      "slides.s1.titleHtml": "<span class=\"ref-title-accent\">Small Guided Missile</span><br>SGM “VESNA”",
      "slides.s1.p1": "The SGM “Vesna” is a guided missile based on the production-ready Hydra 70 platform, designed for mass deployment against small aerial targets.",
      ...
      "slides.s3.p1": "The SGM “Vesna” modernises the standard Hydra 70 rocket by installing a control module and implementing a combined guidance system.",
      "slides.s3.list1": "weight ~14 kg",
      "slides.s3.list2": "length ~1.8 m",
      ...
      "sections.architecture.list1": "SGM “Vesna” guided missiles",
